...
$.ajax({ beforeSend: function(request) {             var Authentication = localStorage.getItem("Authentication");             request.setRequestHeader("Authentication", Authentication);         },type:opts.method,url:opts.url,data:_1d0,dataType:"json",success:function(data){
_1d1(data);
},error:function(){
...
$.ajax({ beforeSend: function(request) {             var Authentication = localStorage.getItem("Authentication");             request.setRequestHeader("Authentication", Authentication);         },type:opts.method,url:opts.href,cache:false,data:_27c,dataType:"html",success:function(data){
_27d(data);
},error:function(){
...
$.fn.window.defaults=$.extend({},$.fn.panel.defaults,{zIndex:1600,draggable:true,resizable:true,shadow:true,modal:false,border:true,inline:false,title:"New Window",collapsible:true,minimizable:true,maximizable:true,closable:true,closed:false,constrain:false});
})(jQuery);
(function($){
function _2b0(_2b1){
...
_425($("body>div.em_menu:visible").not(".em_menu-inline"));
});
});
function init(_426){
var opts=$.data(_426,"menu").options;
$(_426).addClass("em_menu-top");
...
item.empty().append($("<div class=\"em_menu-text\"></div>").html(_433.text));
if(_433.iconCls){
$("<div class=\"em_menu-icon\"></div>").addClass(_433.iconCls).appendTo(item);
}
if(_433.id){
...
if(item[0].submenu){
$("<div class=\"em_menu-rightarrow\"></div>").appendTo(item);
}
}
};
...
$(this).find(".em_menu-text").css({height:(opts.itemHeight-2)+"px",lineHeight:(opts.itemHeight-2)+"px"});
});
...
menu.children("div.em_menu-line")._outerHeight(_43b-2);
if(!_437){
menu.hide();
}
};
...
menu[0].shadow.css({display:(menu.hasClass("em_menu-inline")?"none":"block"),zIndex:$.fn.menu.defaults.zIndex++,left:menu.css("left"),top:menu.css("top"),width:menu.outerWidth(),height:menu.outerHeight()});
...
$("<div class=\"em_menu-rightarrow\"></div>").appendTo(_461.parent);
_42c(_460,_462);
}
...
function _46c(_46d){
$(_46d).children("div.em_menu-item").each(function(){
_463(_46d,this);
});
if(_46d.shadow){
_46d.shadow.remove();
...
item.text=_471.text;
$(_471.target).children("div.em_menu-text").html(_471.text);
});
},setIcon:function(jq,_472){
return jq.each(function(){
var item=$(_472.target).data("menuitem").options;
item.iconCls=_472.iconCls;
$(_472.target).children("div.em_menu-icon").remove();
if(_472.iconCls){
$("<div class=\"em_menu-icon\"></div>").addClass(_472.iconCls).appendTo(_472.target);
}
});
...
var data={};
data[_56c[1]]=_56b;
var _56d=$.ajax({ beforeSend: function(request) {             var Authentication = localStorage.getItem("Authentication");             request.setRequestHeader("Authentication", Authentication);         },url:_56c[0],dataType:"json",data:data,async:false,cache:false,type:"post"}).responseText;
return _56d=="true";
...
function _61e(){
if(_61a.menu){
var item=_61a.menu.children("div.em_menu-item:first");
_61a.menu.children("div.em_menu-item").each(function(){
...
$.ajax({ beforeSend: function(request) {             var Authentication = localStorage.getItem("Authentication");             request.setRequestHeader("Authentication", Authentication);         },url:opts.url,type:"post",xhr:function(){
...
$.ajax({ beforeSend: function(request) {             var Authentication = localStorage.getItem("Authentication");             request.setRequestHeader("Authentication", Authentication);         },url:data,data:_642,dataType:"json",success:function(data){
_643(data);
},error:function(){
...
var menu=$(_680).find(".calendar-em_menu");
...
$(_68b).find(".calendar-em_menu").show();
if($(_68b).find(".calendar-em_menu-month-inner").is(":empty")){
$(_68b).find(".calendar-em_menu-month-inner").empty();
var t=$("<table class=\"calendar-mtable\"></table>").appendTo($(_68b).find(".calendar-em_menu-month-inner"));
var idx=0;
for(var i=0;i<3;i++){
...
var sele=$(_68b).find(".calendar-em_menu");
var _68c=sele.find(".calendar-em_menu-year-inner");
var _68d=sele.find(".calendar-em_menu-month-inner");
...
$.ajax({ beforeSend: function(request) {             var Authentication = localStorage.getItem("Authentication");             request.setRequestHeader("Authentication", Authentication);         },type:opts.method,url:opts.url,data:_918,dataType:"json",success:function(data){
_919(data);
},error:function(){
...
$.ajax({ beforeSend: function(request) {             var Authentication = localStorage.getItem("Authentication");             request.setRequestHeader("Authentication", Authentication);         },type:opts.method,url:opts.url,data:_a9b,dataType:"json",success:function(data){
_a9c(data);
},error:function(){
...
$.ajax({ beforeSend: function(request) {             var Authentication = localStorage.getItem("Authentication");             request.setRequestHeader("Authentication", Authentication);         },type:opts.method,url:opts.url,data:_b72,dataType:"json",success:function(data){
_b73(data);
},error:function(){
